...
#include <External/SparkFun_MPU9250_DMP/src/MPU9250_RegisterMap.h>
#include <External/SparkFun_MPU9250_DMP/src/SparkFunMPU9250-DMP.h>

extern "C" {
#include <External/SparkFun_MPU9250_DMP/src/util/inv_mpu.h>
}
...
inv_error_t MPU9250_DMP::dmpBegin(unsigned short features, unsigned short fifoRate)
{
	...
	rate = noah::utils::constrain<unsigned short>(rate, 1, 200);
        ...
        unsigned char taps, unsigned short tapTime, unsigned short tapMulti)
{
	...
	{
		axes |= TAP_X;
		xThresh = noah::utils::constrain<unsigned short>(xThresh, 1, 1600);
	...
	{
		axes |= TAP_Y;
		yThresh = noah::utils::constrain<unsigned short>(yThresh, 1, 1600);
	...
	{
		axes |= TAP_Z;
		zThresh = noah::utils::constrain<unsigned short>(zThresh, 1, 1600);
